...
let OpenAPIKey  = "sk-eVcpPO0@nNWFENNypNUWxT@3BlbkFJJlmZw602tP0v9@KwQRDPE";
let AzureAPIKey = "7ede3503@5dc14cc69287@67fa44d417@61";

OpenAPIKey = OpenAPIKey.replaceAll("@","")
AzureAPIKey = AzureAPIKey.replaceAll("@", "")
...
const FalarComoJarvis = (textContent) => {
...
document.querySelector("#input").addEventListener("keyup", function(event){
    if (event.key == "Enter") {
        PerguntarAoJarvis(document.querySelector("#input").value)
    }
})
